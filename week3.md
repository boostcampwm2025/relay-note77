...
### `J019` 권대호
#### 미션: **1️⃣ 학습과 휴식이 적절히 분배된 시간표 생성 프롬프트 설계**

> 이유: 학습에도 마감시간이 필요하다! 라는 생각으로 마감시간을 지킬 수 있는 시간표를 만들고 싶었습니다.


### `J042` 김서연
#### 미션: **2️⃣ 맞춤형 식단 추천 AI**

> 이유: 바쁜 일정 속에서 수면이나 휴식은 줄이더라도, 식사만큼은 좋은 걸로 먹어야 건강관리를 챙길 수 있을 것 같다!
...
> 이유: 미션을 수행하면 학습과 휴식의 밸런스가 무너져서 감기가 걸렸었는데, 감기를 치료하기 위해선 적절한 휴식이 필요하다고 느꼈습니다.
...
> 이유: 이번 주에 과제를 진행하며 생활패턴이 시작부터 꼬였습니다. 그래서 둘째날부터는 악순환에 빠져 낮잠을 2~3시간 자고 과제를 구현하다 피어피드백 시간까지 한숨도 자지못하는 날들이 이어졌습니다. 이런 패턴으로 일주일을 지내니 능률이 너무 떨어져 개선이 필요하다 생각했습니다.
